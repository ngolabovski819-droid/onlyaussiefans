...
export const states: StateConfig[] = [
  ...
  },
  {
    ...
    label: 'Victoria',
    abbr: 'VIC',
    terms: ['vic', 'victoria', 'melbourne', 'geelong', 'ballarat', 'bendigo', 'shepparton', 'mildura', 'warrnambool', 'traralgon', 'wodonga', 'dandenong', 'frankston', 'st kilda', 'brunswick', 'fitzroy', 'collingwood', 'richmond', 'south yarra', 'prahran'],
  ...
  },
  {
    ...
    abbr: 'WA',
    terms: ['wa', 'western australia', 'perth', 'fremantle', 'bunbury', 'geraldton', 'albany', 'mandurah', 'rockingham', 'kalgoorlie', 'margaret river', 'broome', 'port hedland', 'karratha', 'busselton', 'joondalup', 'cottesloe', 'scarborough', 'subiaco', 'northbridge'],
  ...
  },
  {
    ...
    abbr: 'SA',
    terms: ['sa', 'south australia', 'adelaide', 'mount gambier', 'whyalla', 'port augusta', 'port pirie', 'victor harbor', 'gawler', 'murray bridge', 'barossa', 'mclaren vale', 'norwood', 'unley', 'glenelg', 'port adelaide', 'salisbury', 'tea tree gully'],
  ...
  },
  {
    ...
    label: 'Tasmania',
    abbr: 'TAS',
    terms: ['tas', 'tasmania', 'hobart', 'launceston', 'devonport', 'burnie', 'ulverstone', 'kingston', 'glenorchy', 'new norfolk', 'sandy bay', 'battery point', 'moonah', 'clarence'],
  ...
  },
  {
    ...
    abbr: 'NT',
    terms: ['nt', 'northern territory', 'darwin', 'alice springs', 'palmerston', 'katherine', 'nhulunbuy', 'tennant creek', 'casuarina', 'nightcliff', 'fannie bay', 'parap'],
