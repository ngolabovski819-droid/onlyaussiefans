...
export const states: StateConfig[] = [
  ...
  },
  {
    ...
    abbr: 'WA',
    terms: ['wa', 'western australia', 'perth', 'fremantle', 'bunbury', 'geraldton', 'albany', 'mandurah', 'rockingham', 'kalgoorlie', 'margaret river', 'broome', 'port hedland', 'karratha', 'joondalup', 'armadale', 'stirling', 'wanneroo'],
  ...
  },
  {
    ...
    abbr: 'SA',
    terms: ['sa', 'south australia', 'adelaide', 'mount gambier', 'whyalla', 'port augusta', 'port pirie', 'victor harbor', 'gawler', 'murray bridge', 'barossa', 'mclaren vale'],
  ...
  },
  {
    ...
    abbr: 'NT',
    terms: ['nt', 'northern territory', 'darwin', 'alice springs', 'palmerston', 'katherine', 'nhulunbuy', 'tennant creek', 'top end'],
