...
export const states: StateConfig[] = [
  {
    ...
    abbr: 'NSW',
    terms: ['nsw', 'new south wales', 'sydney', 'newcastle', 'wollongong', 'central coast', 'canberra'],
  ...
  },
  {
    ...
    label: 'Victoria',
    abbr: 'VIC',
    terms: ['vic', 'victoria', 'melbourne', 'geelong', 'ballarat', 'bendigo'],
  ...
  },
  {
    ...
    label: 'Queensland',
    abbr: 'QLD',
    terms: ['qld', 'queensland', 'brisbane', 'gold coast', 'sunshine coast', 'cairns', 'townsville'],
  ...
  },
  {
    ...
    abbr: 'ACT',
    terms: ['act', 'canberra', 'australian capital territory'],
  ...
  },
  {
    ...
    label: 'Tasmania',
    abbr: 'TAS',
    terms: ['tas', 'tasmania', 'hobart', 'launceston'],
