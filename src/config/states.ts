...
export const states: StateConfig[] = [
  {
    ...
    abbr: 'NSW',
    terms: ['nsw', 'new south wales', 'sydney', 'newcastle nsw', 'wollongong', 'central coast', 'parramatta', 'penrith', 'coffs harbour', 'port macquarie', 'byron bay', 'albury', 'wagga wagga', 'dubbo', 'tamworth', 'lismore', 'tweed heads', 'bathhurst', 'gosford', 'bondi', 'manly', 'surry hills', 'newtown'],
  ...
  },
  {
    ...
    abbr: 'NT',
    terms: ['northern territory', 'darwin', 'alice springs', 'palmerston nt', 'katherine nt', 'nhulunbuy', 'tennant creek', 'casuarina', 'nightcliff', 'fannie bay', 'parap'],
