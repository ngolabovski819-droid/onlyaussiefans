...
export const states: StateConfig[] = [
  {
    ...
    abbr: 'NSW',
    terms: ['nsw', 'new south wales', 'sydney', 'newcastle', 'wollongong', 'central coast', 'parramatta', 'penrith', 'blacktown', 'maitland', 'cessnock', 'albury', 'wagga wagga', 'orange', 'dubbo', 'tamworth', 'lismore', 'coffs harbour', 'port macquarie', 'bathurst', 'griffith', 'broken hill', 'tweed heads', 'shellharbour', 'kiama', 'nowra', 'bega', 'gosford', 'bondi', 'manly', 'surry hills', 'newtown', 'glebe', 'balmain', 'paddington', 'darlinghurst', 'redfern', 'chippendale', 'ultimo', 'pyrmont', 'rozelle', 'leichhardt', 'marrickville', 'ashfield', 'strathfield', 'burwood', 'auburn', 'granville', 'fairfield', 'liverpool', 'campbelltown', 'cronulla', 'sutherland', 'hurstville', 'kogarah', 'rockdale', 'botany', 'randwick', 'coogee', 'maroubra', 'dee why', 'mona vale', 'chatswood', 'hornsby', 'turramurra', 'castle hill', 'baulkham hills', 'seven hills', 'quakers hill', 'richmond', 'windsor', 'bowral', 'mittagong', 'goulburn', 'yass', 'mudgee', 'armidale', 'inverell', 'glen innes', 'grafton', 'ballina', 'byron bay', 'murwillumbah', 'kempsey', 'nambucca heads', 'forster', 'taree', 'clarence valley', 'the entrance', 'wyong', 'terrigal'],
  ...
  },
  {
    ...
    label: 'Victoria',
    abbr: 'VIC',
    terms: ['vic', 'victoria', 'melbourne', 'geelong', 'ballarat', 'bendigo', 'shepparton', 'mildura', 'wodonga', 'albury', 'warrnambool', 'traralgon', 'dandenong', 'frankston', 'ringwood', 'sunbury', 'bacchus marsh', 'torquay', 'moe', 'hamilton', 'horsham', 'swan hill', 'echuca', 'sale', 'bairnsdale', 'collingwood', 'fitzroy', 'st kilda', 'brunswick', 'prahran', 'richmond', 'south yarra', 'toorak', 'hawthorn', 'camberwell', 'box hill', 'glen waverley', 'springvale', 'noble park', 'clayton', 'caulfield', 'carnegie', 'glen iris', 'malvern', 'armadale', 'stonnington', 'port melbourne', 'south melbourne', 'albert park', 'elwood', 'brighton', 'bayside', 'chelsea', 'mordialloc', 'mentone', 'aspendale', 'patterson lakes', 'carrum', 'seaford', 'kananook', 'oakleigh', 'mount waverley', 'vermont', 'wantirna', 'knoxfield', 'boronia', 'bayswater', 'croydon', 'lilydale', 'healesville', 'yarra valley', 'mornington', 'rosebud', 'rye', 'sorrento', 'portsea', 'pakenham', 'berwick', 'narre warren', 'cranbourne', 'officer', 'melton', 'werribee', 'hoppers crossing', 'altona', 'footscray', 'sunshine', 'st albans', 'sydenham', 'craigieburn', 'epping', 'mill park', 'diamond creek', 'eltham', 'greensborough', 'bundoora', 'reservoir', 'preston', 'thornbury', 'northcote', 'coburg'],
  ...
  },
  {
    ...
    label: 'Queensland',
    abbr: 'QLD',
    terms: ['qld', 'queensland', 'brisbane', 'gold coast', 'sunshine coast', 'cairns', 'townsville', 'toowoomba', 'rockhampton', 'mackay', 'bundaberg', 'hervey bay', 'gladstone', 'ipswich', 'noosa', 'caloundra', 'maroochydore', 'mooloolaba', 'surfers paradise', 'broadbeach', 'robina', 'logan', 'springfield', 'caboolture', 'redcliffe', 'mount isa', 'emerald', 'roma', 'charters towers', 'fortitude valley', 'newstead', 'teneriffe', 'new farm', 'kangaroo point', 'west end', 'south bank', 'south brisbane', 'woolloongabba', 'annerley', 'yeronga', 'graceville', 'indooroopilly', 'toowong', 'paddington', 'red hill', 'kelvin grove', 'bowen hills', 'albion', 'clayfield', 'ascot', 'hamilton', 'bulimba', 'hawthorne', 'coorparoo', 'greenslopes', 'camp hill', 'morningside', 'balmoral', 'manly', 'wynnum', 'capalaba', 'alexandra hills', 'mount gravatt', 'eight mile plains', 'sunnybank', 'coopers plains', 'acacia ridge', 'inala', 'richlands', 'oxley', 'jindalee', 'middle park', 'chuwar', 'helensvale', 'coomera', 'upper coomera', 'pimpama', 'ormeau', 'yatala', 'beenleigh', 'eagleby', 'labrador', 'southport', 'biggera waters', 'runaway bay', 'paradise point', 'sanctuary cove', 'hope island', 'varsity lakes', 'mudgeeraba', 'varsity lakes', 'coolangatta', 'tweed heads', 'bli bli', 'nambour', 'kawana waters', 'buddina', 'parrearra', 'bokarina', 'wurtulla', 'birtinya', 'sippy downs', 'palmview', 'buderim', 'forest glen', 'mount coolum', 'peregian beach', 'noosaville', 'noosa heads', 'tewantin'],
  ...
  },
  {
    ...
    abbr: 'WA',
    terms: ['wa', 'western australia', 'perth', 'fremantle', 'bunbury', 'geraldton', 'albany', 'mandurah', 'rockingham', 'kalgoorlie', 'margaret river', 'broome', 'port hedland', 'karratha', 'joondalup', 'armadale', 'stirling', 'wanneroo', 'cottesloe', 'scarborough', 'northbridge', 'subiaco', 'victoria park', 'cannington', 'midland', 'ellenbrook', 'baldivis', 'busselton', 'esperance', 'northam', 'carnarvon', 'exmouth', 'two rocks', 'yanchep', 'como', 'claremont', 'nedlands', 'mosman park', 'east perth', 'west perth', 'south perth', 'north perth', 'leederville', 'mount lawley', 'highgate', 'bayswater', 'maylands', 'ascot', 'burswood', 'carlisle', 'st james', 'bentley', 'wilson', 'manning', 'waterford', 'bull creek', 'willetton', 'shelley', 'canning vale', 'gosnells', 'thornlie', 'beckenham', 'maddington', 'kenwick', 'forrestfield', 'wattle grove', 'maida vale', 'high wycombe', 'belmont', 'ascot', 'cloverdale', 'rivervale', 'lathlain', 'redcliffe', 'bassendean', 'guildford', 'beechboro', 'malaga', 'morley', 'dianella', 'yokine', 'nollamara', 'westminster', 'mirrabooka', 'balga', 'girrawheen', 'koondoola', 'halidon', 'wangara', 'landsdale', 'madeley', 'darch', 'kingsway', 'woodvale', 'craigie', 'hillarys', 'mullaloo', 'ocean reef', 'kallaroo', 'currambine', 'kinross', 'clarkson', 'butler', 'ridgewood', 'banksia grove', 'merriwa', 'mindarie', 'quinns rocks', 'tamala park', 'alkimos', 'eglinton', 'floreat', 'wembley', 'innaloo', 'karrinyup', 'duncraig', 'carine', 'marmion', 'sorrento', 'padbury', 'warwick'],
  ...
  },
  {
    ...
    abbr: 'SA',
    terms: ['sa', 'south australia', 'adelaide', 'mount gambier', 'whyalla', 'port augusta', 'port pirie', 'victor harbor', 'gawler', 'murray bridge', 'barossa', 'mclaren vale', 'norwood', 'unley', 'glenelg', 'port adelaide', 'salisbury', 'elizabeth', 'modbury', 'tea tree gully', 'mount barker', 'naracoorte', 'renmark', 'loxton', 'port lincoln', 'ceduna', 'kadina', 'bordertown', 'semaphore', 'henley beach', 'brighton', 'marion', 'north adelaide', 'prospect', 'broadview', 'clearview', 'northfield', 'enfield', 'gepps cross', 'pooraka', 'mawson lakes', 'parafield', 'para hills', 'para vista', 'ingle farm', 'valley view', 'holden hill', 'hillbank', 'brahma lodge', 'direk', 'burton', 'angle vale', 'virginia', 'davoren park', 'andrews farm', 'blakeview', 'craigmore', 'munno para', 'smithfield', 'playford', 'hackham', 'morphett vale', 'christies beach', 'noarlunga', 'seaford', 'aldinga', 'willunga', 'stirling', 'crafers', 'bridgewater', 'hahndorf', 'balhannah', 'lobethal', 'woodside', 'verdun', 'mylor', 'blackwood', 'belair', 'mitcham', 'colonel light gardens', 'kingston park', 'seacliff', 'somerton park', 'south plympton', 'edwardstown', 'clovelly park', 'daw park', 'pasadena', 'st marys', 'panorama', 'eden hills', 'hawthorndene', 'coromandel valley', 'aberfoyle park', 'happy valley', 'flagstaff hill', 'woodcroft', 'gledswood hills', 'lonsdale'],
  ...
  },
  {
    ...
    abbr: 'ACT',
    terms: ['act', 'canberra', 'australian capital territory', 'belconnen', 'woden', 'tuggeranong', 'gungahlin', 'queanbeyan', 'civic', 'city', 'braddon', 'reid', 'ainslie', 'watson', 'hackett', 'lyneham', 'o\'connor', 'turner', 'acton', 'parkes', 'barton', 'kingston', 'griffith', 'narrabundah', 'forrest', 'deakin', 'yarralumla', 'red hill', 'garran', 'hughes', 'torrens', 'curtin', 'mawson', 'farrer', 'isaacs', 'chifley', 'florey', 'macquarie', 'page', 'scullin', 'evatt', 'mckellar', 'latham', 'charnwood', 'dunlop', 'spence', 'holt', 'fraser', 'higgins', 'kippax', 'macgregor', 'cook', 'aranda', 'bruce', 'kaleen', 'giralang', 'melba', 'lawson', 'barton', 'greenway', 'gordon', 'calwell', 'banks', 'conder', 'bonython', 'richardson', 'theodore', 'gowrie', 'gilmore', 'wanniassa', 'kambah', 'macarthur', 'oxley', 'holder', 'duffy', 'rivett', 'waramanga', 'weston', 'chapman', 'fisher', 'stirling', 'lyons', 'wright', 'coombs', 'molonglo'],
  ...
  },
  {
    ...
    label: 'Tasmania',
    abbr: 'TAS',
    terms: ['tas', 'tasmania', 'hobart', 'launceston', 'devonport', 'burnie', 'ulverstone', 'kingston', 'glenorchy', 'new norfolk', 'sorell', 'scottsdale', 'queenstown', 'rosebery', 'sandy bay', 'battery point', 'south hobart', 'west hobart', 'north hobart', 'glebe', 'new town', 'moonah', 'lutana', 'montrose', 'derwent park', 'claremont', 'berriedale', 'granton', 'bridgewater', 'risdon vale', 'lindisfarne', 'rose bay', 'bellerive', 'clarence', 'rokeby', 'howrah', 'mornington', 'tranmere', 'warrane', 'rosny', 'cambridge', 'richmond', 'brighton', 'george town', 'longford', 'campbell town', 'ross', 'oatlands', 'swansea', 'bicheno', 'st helens', 'st marys', 'fingal', 'friendly beaches', 'strahan', 'zeehan', 'smithton', 'stanley', 'wynyard', 'penguin', 'sheffield', 'deloraine', 'westbury', 'hagley', 'hadspen', 'evandale', 'lilydale', 'beaconsfield', 'beauty point', 'ex mouth', 'bridport', 'huonville', 'cygnet', 'geeveston', 'dover', 'southport'],
  ...
  },
  {
    ...
    abbr: 'NT',
    terms: ['nt', 'northern territory', 'darwin', 'alice springs', 'palmerston', 'katherine', 'nhulunbuy', 'tennant creek', 'top end', 'casuarina', 'nightcliff', 'fannie bay', 'parap', 'larrakeyah', 'humpty doo', 'jabiru', 'yulara', 'litchfield', 'batchelor', 'tiwi islands', 'rapid creek', 'nakara', 'wanguri', 'anula', 'moil', 'leanyer', 'karama', 'malak', 'marrara', 'berrimah', 'winnellie', 'stuart park', 'the gardens', 'darwin city', 'darwin cbd', 'woolner', 'bayview', 'east point', 'ludmilla', 'coconut grove', 'millner', 'buffalo creek', 'lee point', 'wagaman', 'tiwi', 'alawa', 'jingili', 'brinkin', 'muirhead', 'lyons', 'bellamack', 'mitchell', 'driver', 'durack', 'gray', 'moulden', 'woodroffe', 'rosebery', 'farrar', 'gunn', 'zuccoli', 'holtze', 'noonamah', 'virginia', 'acacia hills', 'bees creek', 'freds pass', 'marrakai', 'pine creek', 'mataranka', 'daly waters', 'elliot', 'renner springs', 'ti tree', 'barrow creek'],
