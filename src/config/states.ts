...
export const states: StateConfig[] = [
  {
    ...
    abbr: 'NSW',
    terms: ['nsw', 'new south wales', 'sydney', 'newcastle', 'wollongong', 'central coast', 'parramatta', 'penrith', 'blacktown', 'maitland', 'cessnock', 'albury', 'wagga wagga', 'orange', 'dubbo', 'tamworth', 'lismore', 'coffs harbour', 'port macquarie', 'bathurst', 'griffith', 'broken hill', 'tweed heads', 'shellharbour', 'kiama', 'nowra', 'bega', 'gosford'],
  ...
  },
  {
    ...
    label: 'Victoria',
    abbr: 'VIC',
    terms: ['vic', 'victoria', 'melbourne', 'geelong', 'ballarat', 'bendigo', 'shepparton', 'mildura', 'wodonga', 'albury', 'warrnambool', 'traralgon', 'dandenong', 'frankston', 'ringwood', 'sunbury', 'bacchus marsh', 'torquay', 'moe', 'hamilton', 'horsham', 'swan hill', 'echuca', 'sale', 'bairnsdale', 'collingwood', 'fitzroy', 'st kilda', 'brunswick', 'prahran'],
  ...
  },
  {
    ...
    label: 'Queensland',
    abbr: 'QLD',
    terms: ['qld', 'queensland', 'brisbane', 'gold coast', 'sunshine coast', 'cairns', 'townsville', 'toowoomba', 'rockhampton', 'mackay', 'bundaberg', 'hervey bay', 'gladstone', 'ipswich', 'noosa', 'caloundra', 'maroochydore', 'mooloolaba', 'surfers paradise', 'broadbeach', 'robina', 'logan', 'springfield', 'caboolture', 'redcliffe', 'mount isa', 'emerald', 'Roma', 'charters towers'],
  ...
  },
  {
    ...
    abbr: 'WA',
    terms: ['wa', 'western australia', 'perth', 'fremantle', 'bunbury', 'geraldton', 'albany', 'mandurah', 'rockingham', 'kalgoorlie', 'margaret river', 'broome', 'port hedland', 'karratha', 'joondalup', 'armadale', 'stirling', 'wanneroo', 'cottesloe', 'scarborough', 'northbridge', 'subiaco', 'victoria park', 'cannington', 'midland', 'ellenbrook', 'baldivis', 'busselton', 'esperance', 'northam', 'carnarvon', 'exmouth', 'two rocks', 'yanchep', 'como', 'claremont', 'nedlands', 'mosman park'],
  ...
  },
  {
    ...
    abbr: 'ACT',
    terms: ['act', 'canberra', 'australian capital territory', 'belconnen', 'woden', 'tuggeranong', 'gungahlin', 'queanbeyan'],
  ...
  },
  {
    ...
    label: 'Tasmania',
    abbr: 'TAS',
    terms: ['tas', 'tasmania', 'hobart', 'launceston', 'devonport', 'burnie', 'ulverstone', 'kingston', 'glenorchy', 'new norfolk', 'sorell', 'scottsdale', 'queenstown', 'rosebery'],
  ...
  },
  {
    ...
    abbr: 'NT',
    terms: ['nt', 'northern territory', 'darwin', 'alice springs', 'palmerston', 'katherine', 'nhulunbuy', 'tennant creek', 'top end', 'casuarina', 'nightcliff', 'fannie bay', 'parap', 'larrakeyah', 'humpty doo', 'jabiru', 'yulara', 'litchfield', 'batchelor', 'tiwi islands'],
