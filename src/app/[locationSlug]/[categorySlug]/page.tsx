...
import { getCategoryBySlug, popularCategories } from '@/config/categories';
import { fetchSponsoredPage, locationCategoryScope } from '@/config/featured';
...
export default async function LocationCategoryPage({ params }: Props) {
  ...
  const loc = (state ?? city)!;
  const scope = locationCategoryScope(locationSlug, categorySlug);
      ...
      <div className="location-page">
        ...
        <div className="location-page-header">
          ...
          <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem' }}>
            Australian {cat.label.toLowerCase()} creators from {loc.label}
          </p>
